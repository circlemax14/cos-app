...
// This screen was written on a branch where RouteErrorBoundary did not exist
// (it was reverted off main), so it was the one route without a boundary. Same
// rule as every other: a render error costs this screen, not the whole app.
