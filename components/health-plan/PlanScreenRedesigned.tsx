...
/**
 * COS-360 / SCRUM-577 — flag-aware label. See PlanScreenRedesignedV2 for
 * detailed rationale. When resolver supplied, agency-supported → "Family
 * Support" if ASSESSMENT_STRATEGY_V2_ENABLED is on.
 */
